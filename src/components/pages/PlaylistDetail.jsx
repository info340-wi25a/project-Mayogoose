...
// function PlaylistDetail({ selectedWarmups = [], clearWarmups, removeWarmup  }) {
//     const { playlistId } = useParams(); 
//     const playlist = playlistData.find(p => p.playlistId === playlistId);

//     const [localWarmups, setLocalWarmups] = useState(selectedWarmups);

//     const handleRemoveWarmup = (warmupId) => {
//         removeWarmup(warmupId); 
//         setLocalWarmups(prev => prev.filter(w => w.warmupId !== warmupId));  
//     };
...
//                     <p><strong>Difficulty:</strong> {warmup["Difficulty Level"]}</p>
//                 </div>
//                 <button onClick={() => handleRemoveWarmup(warmup.warmupId)}>−</button>
//             </div>
//         ));
//     };
...
//                         {selectedWarmups.length > 0 && (
//                         <div className="warmups-list">
//                             {renderSelectedWarmups(localWarmups)}
//                         </div>
//                     )}
//                     {selectedWarmups.length === 0 && <p>Add Your Warmups</p>}
//                     </>
